...
// Check if the user is already logged in, if yes then redirect her to welcome page
                ...
                if (mysqli_stmt_num_rows($stmt)== 1){
                    ...
                    if (mysqli_stmt_fetch($stmt)){
                        if (password_verify($password, $hashed_password)){
                            ...
                            header("Location: admin.php");
//                            echo $username.$_SESSION["loggedin"];
...
<div class="wrapper">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" id="myform" onsubmit="validLogin()">
